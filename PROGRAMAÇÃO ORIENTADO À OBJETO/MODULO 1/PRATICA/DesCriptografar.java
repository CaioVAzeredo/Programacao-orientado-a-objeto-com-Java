...
public class DesCriptografar { 
  public static void main(String[] args) { 
    ...
    // Passa o texto cifrado para maiusculas 
    ...
    for(int i = 0; i < textoCifrado.length(); i++) { 
      ...
      // Recupera a posicao do caractere do texto cifrado no alfabeto 
      char caractereCifrado = textoCifrado.charAt(i) ; 
      int posCaractereCifradoAlfabeto = alfabeto.indexOf(caractereCifrado) ; 

      // Se o caractere cifrado nao está no alfabeto (como um espaco), ignora a codificacao      
