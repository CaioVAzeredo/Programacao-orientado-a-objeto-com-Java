...
public class Criptografar {
  ...
  public static void main(String[] args) {
    ...
    // Passa o texto informado para maiusculas
    ...
    for (int i = 0; i < textoOriginal.length(); i++) {
      ...
      // Se o caractere nao está no alfabeto (como um espaco), ignora a codificacao
    ...
    System.out.println("Texto criptografado: " + textoCifrado + ". chave: " + chave);
  }
